        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fechaCUsuario = table.Column<DateTime>(type: "datetime", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    contenidoEvento = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idNoticia = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    idUsuario = table.Column<int>(type: "int", nullable: false),
                    tituloNoticia = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    contenidoNoticia = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    noticiaStatus = table.Column<bool>(type: "bit", nullable: false),
                    fechaNoticia = table.Column<DateTime>(type: "datetime", nullable: false),
                    foto = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
